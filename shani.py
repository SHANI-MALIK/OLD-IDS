...
def ____banner____():
    ...
    print(GREEN + "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" + RESET)
    print(f"{CYAN}{GREEN}➢ Tool Owner : {YELLOW}SHANI MALIK{RESET}")
    print(f"{CYAN}{GREEN}➢ WhatsApp   : {BLUE}+923200795589{RESET}")
    print(f"{CYAN}{GREEN}➢ Tool Type  : {PREMIUM PAID TOOL{RESET}")
    print(f"{CYAN}{GREEN}➢ Version    : {GREEN}1.0{RESET}")
    print(f"{CYAN}{GREEN}➢ Device Key : {PURPLE}{user_key if user_key else 'LOADING...'}{RESET}")
    print(f"{CYAN}{GREEN}➢ Expiry     : {PINK}{exp if exp else 'N/A'}{RESET}")
    print(f"{CYAN}{GREEN}➢ Time Left  : {RED}{left if left else 'N/A'}{RESET}")
    print(GREEN + "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" + RESET)
